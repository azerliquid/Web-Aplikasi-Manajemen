...
$id = $_GET['id'];
$sql = mysqli_query($konek, "SELECT * FROM event INNER JOIN kategori ON event.jenis_event=kategori.id_kategori WHERE jenis_event='$id'");
?>
...
<div class="blog" id="blog">
        <div class="container">
            <h1 class="text-center">Event <?php echo $_GET['halaman'] ?></h1>
            <div class="row">
